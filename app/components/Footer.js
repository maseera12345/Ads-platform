      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">AdFlow Pro</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/ads" className="text-slate-300 hover:text-white transition-colors">Browse Ads</a></li>
              <li><a href="/create" className="text-slate-300 hover:text-white transition-colors">Create Ad</a></li>
              <li><a href="/dashboard" className="text-slate-300 hover:text-white transition-colors">Dashboard</a></li>
              <li><a href="/packages" className="text-slate-300 hover:text-white transition-colors">Packages</a></li>
            </ul>
          </div>

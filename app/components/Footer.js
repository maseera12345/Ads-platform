        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-400 mb-4 max-w-md leading-relaxed">
              Professional ad management platform for businesses. Create, manage, and publish your advertisements with ease.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/ads" className="text-slate-400 hover:text-blue-400 transition-colors duration-200">Browse Ads</a></li>
              <li><a href="/create" className="text-slate-400 hover:text-blue-400 transition-colors duration-200">Create Ad</a></li>
              <li><a href="/dashboard" className="text-slate-400 hover:text-blue-400 transition-colors duration-200">Dashboard</a></li>
              <li><a href="/packages" className="text-slate-400 hover:text-blue-400 transition-colors duration-200">Packages</a></li>
            </ul>
          </div>
